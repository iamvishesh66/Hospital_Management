...
class MainFrame:
    ...
    def showwidgets(self,name):
        if name == "self.canvas1":
            self.kid1 = Button(self.canvas1, bg="navajo white", height=120, width=143, image=self.img_1
                                , text="ADD\nDOCTOR",font=("segoe",15,"italic"), compound="top")
            self.kid1.bind("<Enter>", lambda e :self.kid1.config(text="ACCESS\nDENIED"))
            self.kid1.bind("<Leave>", lambda e: self.kid1.config(text="ADD\nDOCTOR"))
            self.kid1.grid(row=0, column=0)

            self.kid2 = Button(self.canvas1, bg="navajo white", height=120, width=143, image=self.img_2
                               , text="UPDATE\nDOCTOR", font=("segoe",15,"italic"), compound="top")
            self.kid2.bind("<Enter>", lambda e: self.kid2.config(text="ACCESS\nDENIED"))
            self.kid2.bind("<Leave>", lambda e: self.kid2.config(text="UPDATE\nDOCTOR"))
            self.kid2.grid(row=0, column=1)

            self.kid3 = Button(self.canvas1, bg="navajo white", height=120, width=143, image=self.img_3
                               , text="REMOVE\nDOCTOR", font=("segoe",15,"italic"), compound="top")
            self.kid3.bind("<Enter>", lambda e: self.kid3.config(text="ACCESS\nDENIED"))
            self.kid3.bind("<Leave>", lambda e: self.kid3.config(text="REMOVE\nDOCTOR"))
