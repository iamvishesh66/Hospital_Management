...
class navigator:
    ...
    def __init__(self, parent,a,b):
        ...
        self.canvas1.create_text(160, 20, text="Super Admin", font=("Sitka Heading", 16), fill="yellow")
        self.canvas1.create_text(140, 50, text="ADMIN", font=("Sitka Heading", 12, "bold"), fill="white")
    ...
    def highlight(self,name):
        if name == "canvas1":
            ...
            self.b1 = Button(self.canvas3,image=self.img_1, height=30, width=30, bg="dark orange",command=lambda :add_doc(self.a,20,40))
            self.b1.place(x=230,y=0)
            self.b1.bind("<Button>", lambda e:self.datastorage.append("add_doc"))
            self.b2 = Button(self.canvas3, image=self.img_3, height=30, width=30, bg="dark orange",command=lambda :del_doc(self.a,20,40))
            self.b2.place(x=230, y=35)
            self.b2.bind("<Button>", lambda e: self.datastorage.append("del_doc"))
            self.b3 = Button(self.canvas3, image=self.img_2, height=30, width=30, bg="dark orange",command=lambda: upd_doc(self.a, 20, 40))
            self.b3.place(x=265, y=0)
            self.b3.bind("<Button>", lambda e: self.datastorage.append("upd_doc"))
            self.b4 = Button(self.canvas3, image=self.img_6, height=30, width=30, bg="dark orange",command=lambda : vei_doc(self.a, 20, 40))
            ...
            self.canvas1.config(bg="dodger blue3", highlightbackground="dodger blue3")
            # lets create some buttons
            self.b1 = Button(self.canvas4, image=self.img_1, height=30, width=30, bg="dark orange",command=lambda :add_nur(self.a,20,40))
            self.b1.place(x=230, y=0)
            self.b1.bind("<Button>", lambda e: self.datastorage.append("add_nur"))
            self.b2 = Button(self.canvas4, image=self.img_3, height=30, width=30, bg="dark orange",command=lambda :del_nur(self.a,20,40))
            self.b2.place(x=230, y=35)
            self.b2.bind("<Button>", lambda e: self.datastorage.append("del_nur"))
            self.b3 = Button(self.canvas4, image=self.img_2, height=30, width=30, bg="dark orange",command=lambda :upd_nur(self.a,20, 40))
            self.b3.place(x=265, y=0)
            self.b3.bind("<Button>", lambda e: self.datastorage.append("upd_nur"))
            self.b4 = Button(self.canvas4, image=self.img_6, height=30, width=30, bg="dark orange",command=lambda : vei_nur(self.a, 20, 40))
            self.b4.place(x=265, y=35)
        ...
        if self.datastorage:
            if not len(self.datastorage) == 1:
                ...
                if a == "add_doc":
                    ...
                    add_doc(self.a,20,40)
                elif a == "del_doc":
                    self.datastorage.pop(a1)
                    del_doc(self.a,20,40)
                elif a == "upd_doc":
                    self.datastorage.pop(a1)
                    upd_doc(self.a,20,40)
                elif a == "vei_doc":
                    self.datastorage.pop(a1)
                    vei_doc(self.a,20,40)
                elif a == "add_nur":
                    self.datastorage.pop(a1)
                    add_nur(self.a,20,40)
                elif a == "del_nur":
                    self.datastorage.pop(a1)
                    del_nur(self.a,20,40)
                elif a == "upd_nur":
                    self.datastorage.pop(a1)
                    upd_nur(self.a,20,40)
                elif a == "vei_nur":
                    self.datastorage.pop(a1)
