...
class add_pat:
    ...
    def __init__(self, parent, a, b):
        ...
        title = Label(self.f2, text="ADD PATIENT", font=("algerian", 20, "bold", "underline"), fg="dodger blue3"
        ...
        l6 = Label(self.f1, text="Room Allotted", background="gray95", font=("arial", 16)).place(x=0, y=320)
        l7 = Label(self.f1, text="Companion's Name", background="gray95", font=("arial", 16)).place(x=0, y=390)
        l8 = Label(self.f1, text="Companion's Phone Number", background="gray95", font=("arial", 16)).place(x=0, y=440)
        ...
        self.e7 = Entry(self.f1, width=50, bg="white", font=("arial", 14, "italic"))
        ...
        self.btn2 = Button(self.f1, text="REFRESH", command=lambda: add_pat(self.pat_win1, 20, 40),
        ...
        try:
            ...
            try:
                ...
                if self.filename == "":
                    ...
                    img.save("patimages//" + self.finalname + ".png")
                dc = d1.cursor()
                dc.execute("insert into patient values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.e1.get(),self.e2.get()
                                                                                 ,self.v1.get(),self.e3.get()
                                                                                 ,self.e4.get("1.0", END),self.e5.get()
                                                                                 ,self.e6.get(),self.e7.get()
                                                                                 , self.finalname + ".png"))
                d1.commit()
                messagebox.showinfo("SAVE", "Data Saved Successfully", parent=self.pat_win1)
                add_pat(self.pat_win1,20,40)
    ...
    def onstart(self):
        try:
            ...
            try:
                dc = d1.cursor()
                dc.execute("SELECT id FROM patient")
                f = dc.fetchall()
                for i in f:
                    for j in i:
                        current_id = j
